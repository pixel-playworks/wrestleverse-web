...
* Brawls and Enforcements
* Handshakes
* Events of 3 types: contract signing, talk show, and wedding
* ‘Low blow’ and ‘eye poke’ added as moves
...
* A DQ finish is suggested after a weapon is used
...
* Negative stat-change incidents are now only offered when the wrestler has enough stat points for the reduction
* Updated the toggle style button to use the new ‘selected’ color style
* Improved the balancing of the morale mechanic